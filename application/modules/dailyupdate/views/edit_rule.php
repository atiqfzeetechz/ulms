<div class="row">
  <div class="col-12 col-sm-12 col-lg-12">
   ...
   <form class="form-horizontal" method="POST" action="<?php echo base_url(); ?>dailyupdate/add_rule/edit" id="updateGetForm">
      <input type="hidden" value="<?php echo base_url(); ?>dailyupdate/add_rule/edit" id="update_post_link">
     <input type="hidden" name="RuleId" value="<?php echo $row[0]->RuleId; ?>">
