<div class="row">
  <div class="col-12 col-sm-12 col-lg-12">
	...
	<form class="form-horizontal" id="insertForm" action="<?php echo base_url(); ?>dailyupdate/add_image_gellery/add" method="POST" enctype="multipart/form-data">
             <input type="hidden" value="<?php echo base_url(); ?>dailyupdate/add_image_gellery/add" id="post_link">
...
<div class="fileinput fileinput-new" data-provides="fileinput" style="border:1px solid #dcdcdc;">
								...
								<div>
									...
									<a href="#" class="btn btn-xs btn-orange fileinput-exists rimg" data-dismiss="fileinput">Remove</a>
								</div>
				</div>
                ...
                <div class="card-footer">
                  ...
                  <div class="tab-pane fade show active" id="custom-tabs-three-home" role="tabpanel" aria-labelledby="custom-tabs-three-home-tab">
                    ...
                    <tr>
                      <td>
                        <b>Status will run on:  09:00 AM</b>
                      </td>
