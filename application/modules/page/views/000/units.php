	...
	<div class="tab-content">
			...
			<div class="tab-pane box" id="add" style="padding: 5px">
             ...
             <form class="form-horizontal" id="insertForm">
                <input type="hidden" value="<?php echo base_url(); ?>master/add_unit_details/add" id="post_link">
				
			<div  class="row" style="border:1px solid #dcdcdc;padding:8px;">
			<div class="col-md-2 col-xs-12"><b>Unit Name : <b></div>
			<div class="col-md-4 col-xs-12"><input class="form-control" name="UnitName"></div>
			</div>
