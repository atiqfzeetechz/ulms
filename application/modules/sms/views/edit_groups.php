<div class="row">
  <div class="col-12 col-sm-12 col-lg-12">
   ...
   <form class="form-horizontal" method="POST" action="<?php echo base_url(); ?>sms/add_groups/edit" id="updateGetForm">
      <input type="hidden" value="<?php echo base_url(); ?>sms/add_groups/edit" id="update_post_link">
