...
$("#ChangeProfilePassForm").on('submit',(function(e) {
      $(".loading").show();
e.preventDefault();
$.ajax({
	url: '<?php echo base_url(); ?>user/changed_pin',
	type: "POST",
	data:  new FormData(this),
	contentType: false,
	cache: false,
...
function filter_data(url) {
  var filters = {
    filterOne: $('#filterOne').val(), 
    filterTwo: $('#filterTwo').val(),
    filterThree: $('#filterThree').val(),
    filterFour: $('#filterFour').val(),
    filterFive: $('#filterFive').val()
  };
  ...
  $.ajax({
    ...
    success: function(data) {
      ...
      $('#country_table').html(result.country_table);  
