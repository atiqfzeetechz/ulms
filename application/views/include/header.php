...
$users_id    = isset($this->session->userdata('user_details')[0]->users_id) ? $this->session->userdata('user_details')[0]->users_id : 1;
$user_name   = isset($this->session->userdata('user_details')[0]->name) ? $this->session->userdata('user_details')[0]->name : 'Admin User';
