...
$AdmissionNo  =  $row[0]['AdmissionNo'];
$StudentPhoto = $row[0]['StudentPhoto']; 
$url = $this->Mdlmaster->getPhoto($AdmissionNo,$StudentPhoto);
...
<table style="width:100%;margin:auto;">
  <tr>
   <td><img src="<?php echo base_url(); ?>uploads/logo/<?php echo$logo; ?>" alt="School Logo" style="width:120px;height:120px;"/></td>
 ...
 ( Affiliated to <?php echo$academic_board ; ?> - <?php  echo$academic_regNo; ?> )<br>
  <?php echo$academic_address; ?>
   ...
   <td align="right"><img src="<?php echo $url; ?>" alt="Board Logo" style="width:120px;height:120px;"/></td>
