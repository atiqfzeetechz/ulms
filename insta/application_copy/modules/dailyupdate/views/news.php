<div class="row">
  <div class="col-12 col-sm-12 col-lg-12">
			...
			<div id="page_number" style="display:none;"></div>
				  ...
				  <form class="form-horizontal" id="insertForm" action="<?php echo base_url(); ?>dailyupdate/add_news/add" method="POST">
             <input type="hidden" value="<?php echo base_url(); ?>dailyupdate/add_news/add" id="post_link">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group col-md-12">
				   ...
				   <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" id="Title" name="Place" placeholder="Enter Place">
                   </div>
