	...
	<div class="tab-content">
			...
			<div class="tab-pane box" id="add" style="padding: 5px">
             ...
             <form class="form-horizontal" id="insertForm">
                <input type="hidden" value="<?php echo base_url(); ?>master/add_city_details/add" id="post_link">
			...
			<div class="col-md-4 col-xs-12"><input class="form-control" name="CityName"></div>
