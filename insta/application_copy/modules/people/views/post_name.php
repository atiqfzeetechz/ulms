<div class="row">
  <div class="col-12 col-sm-12 col-lg-12">
			...
			<div id="page_number" style="display:none;"></div>
				  ...
				  <form class="form-horizontal" id="insertForm" action="<?php echo base_url(); ?>people/add_posts/add" method="POST">
             <input type="hidden" value="<?php echo base_url(); ?>people/add_posts/add" id="post_link">
