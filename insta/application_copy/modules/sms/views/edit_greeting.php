<div class="row">
  <div class="col-12 col-sm-12 col-lg-12">
   ...
   <form class="form-horizontal" method="POST" action="<?php echo base_url(); ?>dailyupdate/add_greeting/edit" id="updateGetForm">
      <input type="hidden" value="<?php echo base_url(); ?>dailyupdate/add_greeting/edit" id="update_post_link">
     <input type="hidden" name="Id" value="<?php echo $row[0]->Id; ?>">
		...
		if(!empty($File))
		{ 
	        $load_url = 'uploads/greeting/'.$File;
