<div class="row">
  <div class="col-12 col-sm-12 col-lg-12">
   ...
   <form class="form-horizontal" method="POST" action="<?php echo base_url(); ?>dailyupdate/add_savidhan/edit" id="updateGetForm">
      <input type="hidden" value="<?php echo base_url(); ?>dailyupdate/add_savidhan/edit" id="update_post_link">
     <input type="hidden" name="id" value="<?php echo $row[0]->id; ?>">
				...
				<div class="row">
                  <div class="form-group col-md-12">
                    ...
                    <input type="text" class="form-control" id="savidhanTitle" name="savidhanTitle" value="<?php echo $row[0]->title; ?>" placeholder="Enter Title">
                   </div>
                  </div>
		...
		if(!empty($File1))
		{ 
	        $load_url1 = 'uploads/savidhan/'.$File1;
