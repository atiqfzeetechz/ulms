<div class="row">
  <div class="col-12 col-sm-12 col-lg-12">
			...
			<div id="page_number" style="display:none;"></div>
				  ...
				  <form class="form-horizontal" id="insertForm" action="<?php echo base_url(); ?>party/add_other_contact/add" method="POST">
             <input type="hidden" value="<?php echo base_url(); ?>dailyupdate/add_other_contact/add" id="post_link">
				...
				<div class="row">
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" id="mobile" name="mobile1" placeholder="Enter Mobile Number">
                   </div>
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" id="mobile" name="mobile2" placeholder="Enter Alt. Mobile Number">
                   </div>
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" id="mobile" name="address" placeholder="Enter Address Number">
                   </div>
