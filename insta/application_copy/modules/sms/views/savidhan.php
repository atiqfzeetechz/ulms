<div class="row">
  <div class="col-12 col-sm-12 col-lg-12">
			...
			<div id="page_number" style="display:none;"></div>
				  ...
				  <form class="form-horizontal" id="insertForm" action="<?php echo base_url(); ?>dailyupdate/add_savidhan/add" method="POST">
             <input type="hidden" value="<?php echo base_url(); ?>dailyupdate/add_savidhan/add" id="post_link">
		
                <div class="card-body">
				   <div class="row">
                  <div class="form-group col-md-12">
                    <label for="exampleInputEmail1">Savidhan Title</label>
                    <input type="text" class="form-control" id="savidhanTitle" name="savidhanTitle" placeholder="Enter Title">
                   </div>
                  </div>
				  <div class="row">
