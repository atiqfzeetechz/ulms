...
<table style="width:90%;margin:auto;">
  <tr>
   <td><img src="<?php echo base_url(); ?>uploads/logo/<?php echo$logo2; ?>" alt="School Logo" style="width:120px;height:120px;"/></td>
 ...
 ( Affiliated to <?php echo$academic_board ; ?> - <?php  echo$academic_regNo; ?> )<br>
  <?php echo$academic_address; ?>
   ...
   <td align="right"><img src="<?php echo base_url(); ?>uploads/logo/<?php echo$logo; ?>" alt="Board Logo" style="width:120px;height:120px;"/></td>
